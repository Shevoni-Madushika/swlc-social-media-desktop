...
public class SubscriberControllerTest extends ApplicationTest {
    ...
    void testSubscribeButton() {
        ...
        LoginController.loggedChannel= new ChannelEntity("99L", "Logged Channel", "user.png");
        ...
        Button subscribeButton = (Button) ((VBox) controller.postPane.getChildren().get(0)).getChildren().get(2);
    ...
    void testUnsubscribeButton() {
        ...
        LoginController.loggedChannel = new ChannelEntity("1", "Logged Channel", "user.png");
        ...
        // Simulate button click
        Button unsubscribeButton = (Button) ((VBox) controller.postPane.getChildren().get(0)).getChildren().get(2);
